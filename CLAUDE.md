...
| `preferences.py` | choose data folder (save + restart) + **"Prepare objects for processing in:"** workflow checkboxes → `processing_workflows` + **"Finished-image hints"** editable keyword fields (finished / intermediate) → `hints.set_hints` (#17) + theme. (Goals moved to the Goals page in 5d.) |
