...
#15). The UI settled into a **4-pane nav rail** — **Library · Overview · Import ·
Processing** — after a pre-launch 8→4 IA cleanup (Summary+Goals merged into
